...
CREATE TABLE `quality_criterion_target_types` (
    ...
    UNIQUE INDEX `quality_criterion_target_types_code_key`(`code`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quality_criteria` (
    ...
    UNIQUE INDEX `quality_criteria_code_key`(`code`),
    INDEX `quality_criteria_status_idx`(`status`),
    INDEX `quality_criteria_created_by_user_id_idx`(`created_by_user_id`),
    INDEX `quality_criteria_category_id_idx`(`category_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quality_criterion_target_type_links` (
    ...
    PRIMARY KEY (`criterion_id`, `target_type_id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `quality_criterion_checks` (
    ...
    UNIQUE INDEX `quality_criterion_checks_distribution_id_context_key`(`distribution_id`, `context`),
    INDEX `quality_criterion_checks_distribution_id_idx`(`distribution_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
VALUES
  ('00000000-0000-4000-8000-000000000001', 'report', 'Report draft', true, 10, true, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3)),
  ('00000000-0000-4000-8000-000000000002', 'path_course', 'Path course', false, 20, true, CURRENT_TIMESTAMP(3), CURRENT_TIMESTAMP(3))
