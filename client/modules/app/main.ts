...
import { HttpGlobalSubmissionRepository } from "@modules/report-draft/core/repository-infra/http.global-submission.repository-infra";
...
export class App {
  ...
  constructor() {
    this.dependencies = {
      ...
      globalSubmissionRepository: new HttpGlobalSubmissionRepository(),
