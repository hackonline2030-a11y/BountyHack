...
import { MentorSubmissionReviewBoard } from "@modules/report-draft/react/pages/MentorSubmissionReviewBoard";
...
export const MentorSubmissionReviewBootstrap: React.FC<Props> = ({
  submissionId,
  reviewerId,
  lng,
}) => {
        ...
        <div className="mx-auto w-full max-w-4xl px-4 py-6">
          ...
          >
            ...
            <Link
              ...
              className="mt-2 inline-block text-dashboard-accent"
            >
              ← Retour à la liste mentor
            </Link>
          </div>
        </div>
      );
